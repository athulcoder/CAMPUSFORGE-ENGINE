      ...
      <div className="ai-glass-card relative z-10 w-full max-w-5xl rounded-3xl overflow-hidden shadow-[0_0_80px_rgba(147,51,234,0.25)] animate-fadeIn grid grid-cols-1 lg:grid-cols-12 border border-purple-500/25">
        ...
        <div className="relative flex flex-col justify-between p-8 sm:p-10 lg:p-12 lg:col-span-7 bg-gradient-to-b from-purple-950/40 to-slate-950/60 border-b lg:border-b-0 lg:border-r border-purple-500/15 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 rounded-full bg-purple-500/15 px-3.5 py-1.5 text-xs font-semibold text-purple-300 border border-purple-400/30 backdrop-blur-md shadow-sm mb-4">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-purple-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-purple-400"></span>
              </span>
              CAMPUS FORGE AI ENGINE v2.0
            </div>

            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
              Autonomous Resume & <br className="hidden sm:inline" />
            ...
            <p className="mt-3 text-sm text-slate-300 max-w-lg leading-relaxed">
              Instant neural candidate profile parsing, automated match scoring, and intelligent candidate recommendations for recruiters.
            </p>
          </div>
          ...
          <div className="relative z-10 my-8 sm:my-10 flex flex-col items-center justify-center">
            <div className="relative w-full max-w-sm sm:max-w-md aspect-square rounded-2xl overflow-hidden p-2 bg-gradient-to-b from-purple-500/20 via-transparent to-cyan-500/20 border border-purple-500/30 shadow-2xl shadow-purple-950/80 animate-float">
              ...
              <div className="absolute top-4 left-4 z-20 flex items-center gap-2 rounded-xl bg-slate-900/80 backdrop-blur-md px-3 py-2 border border-purple-500/30 text-xs font-medium text-white shadow-xl">
                ...
                <div>
                  <div className="text-[10px] text-slate-400 uppercase tracking-wider">Parser Score</div>
                  <div className="font-bold text-emerald-400">98.4% Match Accuracy</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 right-4 z-20 flex items-center gap-2 rounded-xl bg-slate-900/80 backdrop-blur-md px-3 py-2 border border-cyan-500/30 text-xs font-medium text-white shadow-xl">
                ...
                <span className="text-cyan-300 font-semibold">Neural Engine Active</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-3 gap-3 pt-4 border-t border-purple-500/15">
            <div className="flex flex-col items-center text-center">
              <span className="text-base font-bold text-purple-300">Instant</span>
              <span className="text-[11px] text-slate-400">Resume Extraction</span>
            </div>
            <div className="flex flex-col items-center text-center border-x border-purple-500/15">
              <span className="text-base font-bold text-cyan-300">AI Scoring</span>
              <span className="text-[11px] text-slate-400">Role Match Engine</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-base font-bold text-pink-300">100%</span>
              <span className="text-[11px] text-slate-400">Enterprise Ready</span>
            </div>
          </div>
        </div>

        {/* Right Column: Premium AI Login Form (5 cols) */}
        <div className="relative flex flex-col justify-center p-8 sm:p-10 lg:p-12 lg:col-span-5 bg-slate-950/80 backdrop-blur-xl">
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="mt-1 text-xs text-slate-400">
              Access your AI candidate evaluation portal
            </p>
          </div>

          {/* Error Alert */}
          {error && (
            <div className="mb-5 flex items-center gap-3 rounded-xl bg-rose-500/15 p-3.5 text-xs text-rose-200 border border-rose-500/30 animate-shake">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="ai-glass-input w-full rounded-xl py-3 pr-4 pl-10 text-xs sm:text-sm text-white placeholder-slate-500 outline-none"
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="ai-glass-input w-full rounded-xl py-3 pr-10 pl-10 text-xs sm:text-sm text-white placeholder-slate-500 outline-none"
                  value={password}
          ...
          <div className="mt-6 text-center border-t border-purple-500/15 pt-5">
